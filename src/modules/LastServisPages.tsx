    ...
    <section className="flex gap-3">
        <div className="w-[60%] bg-[#F5F6F9] rounded-[20px] p-4 mt-3 overflow-y-auto h-[60%]">
            <div className="flex items-center justify-between p-4">
                <strong className="text-[#2D2D2D] font-medium text-[20px]">Oxirgi servislar</strong>
                <div className="relative w-[60%] ">
                <input type="text" placeholder="Qidirish" className="w-full py-3 pl-3 text-[#7B7B7B] text-[13px] rounded-[40px] bg-[#FFFFFF] outline-none" />
            ...
            <ul className="flex flex-col gap-2">
                <li className="flex items-center justify-between p-3 bg-[#E4ECFE] rounded-[20px]">
                    <div className="flex items-center gap-3">
                        <img src={LocationImg} alt="logo" width={44} height={44} />
                        <div className="">
                            <p className="text-[#2D2D2D]">Brend nomi</p>
        ...
        <div className="w-[40%] bg-[#F5F6F9] rounded-[20px] p-4 mt-3 overflow-y-auto h-[60%]">
            <div className="text-center">
              <img className="w-20 h-20 mx-auto" src={LocationImg} alt="log" width={80} height={80}/>
              <strong className="text-medium text-[#2D2D2D]">Moy almashtirish</strong>
            ...
            <ul className="bg-[#FFFFFF] p-3 rounded-2xl flex flex-col gap-2 my-3">
                <li className="flex items-center justify-between">
                    <p className="text-[#7B7B7B]">Moy brendi</p>
                    <p className="text-[#2D2D2D]">Mobil</p>
                </li>
                <li className="flex items-center justify-between">
                    <p className="text-[#7B7B7B]">Moy turi</p>
                    <p className="text-[#2D2D2D]">Mobil15w-30 synthetic</p>
                </li>
                <li className="flex items-center justify-between">
                    <p className="text-[#7B7B7B]">Kilometer</p>
                    <p className="text-[#2D2D2D]">45 000</p>
                </li>
                <li className="flex items-center justify-between">
                    <p className="text-[#7B7B7B]">Avtoservis</p>
                    <p className="text-[#2D2D2D]">CAR1 A.S.</p>
                </li>
                <li className="flex items-center justify-between">
                    <p className="text-[#7B7B7B]">Manzil</p>
                    <p className="text-[#2D2D2D]">link</p>
                </li>
                <li className="flex items-center justify-between">
                    <p className="text-[#7B7B7B]">Telefon raqam</p>
