          ...
          <div className="flex items-center justify-between">
            <div>
              <img
                ...
                className="w-110 h-45.5! object-cover rounded-lg"
                width={438}
                height={182}
              />
              <div className="flex items-center justify-between px-15 mt-5.5">
                ...
                <div className="inline-flex items-center border-2 border-black rounded-md overflow-hidden text-black font-bold bg-white">
                  ...
                  <div className="px-3 py-1 text-xl tracking-widest border-r-2 border-black">
                    {/* Hamma belgilarni bitta qatorda, bo'shliqsiz chiqarish uchun stringni birlashtiramiz */}
            ...
            <div className="flex-1 relative left-65">
              <div className="flex flex-col items-center gap-4">
                <div className="relative w-64 h-36 overflow-hidden">
                  {(() => {
                    const totalTraveled =
                      selectedCar?.service_status?.distance_traveled || 0;
                    const remaining =
                      selectedCar?.service_status?.remaining_distance || 0;
                    ...
                    const percentage = isOverdue
                      ...
                      : interval === 0
                        ...
                        : Math.min(
                            100,
                            Math.max(0, (totalTraveled / interval) * 100),
                          );

                    const strokeLength = 282.7;
                    const offset =
                      strokeLength - (percentage / 100) * strokeLength;
                    ...
                    return (
                      <>
                        ...
                        <div className="absolute inset-0 flex flex-col items-center justify-end pb-2">
                          ...
                          <span
                            className="text-[36px] font-medium transition-colors duration-500"
