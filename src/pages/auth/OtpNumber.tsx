...
const OtpNumber = () => {
  ...
  const { setPhoneNumber, setCode, setIsForgotPassword } = useContext(
    AuthContext,
  ) as AuthContextType;
    ...
    <section className="containers flex items-center justify-between h-screen">
      <div className="max-w-80 md:min-w-100 px-3 mx-auto">
        ...
        <div className="text-center mt-6 md:mt-9">
          <h3 className="font-medium text-[24px] text-[#2D2D2D]">
            {t("telefon_raqamingizni_kiriting")}
          </h3>
          <p className="text-3.5 text-[#7B7B7B]">
            {t("sizga_tasdiqlash_kodini_SMS_orqali_yuboramiz")}
          </p>
        </div>
        <form onSubmit={(e) => handleSubmit(e)} className="w-full">
          <input
            ...
            placeholder={t("placeholder_telefon_raqam")}
